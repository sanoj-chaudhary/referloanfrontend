    ...
    <section className="home_blogArea" style={{}}>
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-3 order-lg-12">
            <div className="step-imgBox blog_subheading_shadow"><Image src="/images/investment-plan.webp" className="blog_pic" alt="Top 5 Investments" layout="responsive" width="350" height="259" loading='lazy' /></div>
            <div className="blog_dis_area">
