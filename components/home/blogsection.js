  ...
  return (
    ...
    <div className="row">
        ...
        <div className="col-lg-3 order-lg-12">
                <div className="step-imgBox blog_subheading_shadow"><img src="/images/e-mudra.png" className="blog_pic" alt="" width="250" height="300" /></div>
           ...
           <div className="col-lg-3 order-lg-12">
                <div className="step-imgBox blog_subheading_shadow"><img src="/images/investment-plan.png" className="blog_pic" alt="" /></div>
                <div className="blog_dis_area">
           ...
           <div className="col-lg-3 order-lg-12">
                ...
                <div className="step-imgBox blog_subheading_shadow"><img src="/images/policies.png"  className="blog_pic" alt="" /></div>
                <div className="blog_dis_area">
